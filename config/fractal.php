...
return [
    ...
    */
    ...
    |
    */
    'namespace' => env('FRACTAL_NAMESPACE', 'App\Http\Transformers'),
    ...
    */
    ...
    |
    */
    'serializer' => env('FRACTAL_SERIALIZER', '\Gergonzalez\Fractal\Serializers\ArraySerializer'), // DataArraySerializer,JsonApiSerializer, ArraySerializer
